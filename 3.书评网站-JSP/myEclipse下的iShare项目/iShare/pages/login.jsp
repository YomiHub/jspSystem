  ...
  <body>
    ...
    <section class="popup">
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="form_right">
                            <input type="text" name="logname" placeholder="请输入4-12个字符">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="form_right btn">
                            ...
                            <input type="button" onclick="toRegister()" value="还未注册">
                        </td>
                    </tr>
                </tbody>
            </table>
     ...
     <script type="text/javascript">
		function toRegister(){
			document.location.href="${pageContext.request.contextPath }/pages/register.jsp";
		}
	</script>
</body>
</html>
