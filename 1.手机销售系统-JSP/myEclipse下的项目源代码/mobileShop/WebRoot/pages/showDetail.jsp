...
<jsp:useBean id="QueryDetailBean" class="mybean.data.QueryDetail" scope="session"/> 
<%
...
String picBasePath = path+"/images";
...
<html>
  ...
  <body>
    <%
    	...
    	String mobileID = request.getParameter("detail");
    	QueryDetailBean.queryById(mobileID,putGoodsPath,picBasePath);
     %>
     <div align=center>
     <jsp:getProperty name="QueryDetailBean" property="backnews"/>
     </div>
  </body>
</html>
